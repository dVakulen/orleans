...
namespace Orleans.Runtime.Scheduler
{
    internal class WorkQueue
    {
        ...
        static WorkQueue()
        {
            ...
            OrleansThreadPool.RegisterStage(typeof(WorkQueue));
        }
...
#endif
                    OrleansThreadPool.QueueSystemWorkItem(processAction, workItem, typeof(WorkQueue));
                }
                else
                {
#if TRACK_DETAILED_STATS
...
#endif
                    OrleansThreadPool.QueueUserWorkItem(processAction, workItem, typeof(WorkQueue));
                }
#else
#if TRACK_DETAILED_STATS
