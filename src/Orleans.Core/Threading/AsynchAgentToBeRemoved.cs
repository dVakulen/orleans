...
namespace Orleans.Runtime
{
   ...
   */
    ...
    abstract class StagesExecutionPlan
    {
        ...
        public void Get<TStage>(TStage stage)
            where TStage : IStageDefinition
        {
            // should return executor for stage
    ...
    internal abstract class AsynchAgentToBeRemoved : IStageDefinition, ILimitedСoncurrencyStage, IDisposable
    ...
    {  // asyncg agent- stage reference. 
        ...
        protected AsynchAgentToBeRemoved(ExecutorService executorService, string nameSuffix, ILoggerFactory loggerFactory)
        {
