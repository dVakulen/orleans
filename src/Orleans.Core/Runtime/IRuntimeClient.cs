...
namespace Orleans.Runtime
{
    ...
    internal interface IRuntimeClient
    {
        ...
        void SendRequest<T>(GrainReference target, InvokeMethodRequest request, TaskCompletionSource<T> context, string debugContext = null, InvokeMethodOptions options = InvokeMethodOptions.None, string genericArguments = null);
